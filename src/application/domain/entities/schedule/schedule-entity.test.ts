...
describe('ScheduleEntity', () => {
  ...
  describe('create()', () => {
    it('fails when dayOfWeek is negative', () => {
      const error = Schedule.create({ ...validProps, dayOfWeek: -1 }).getError();
    ...
    it('fails when dayOfWeek is greater than 6', () => {
      const error = Schedule.create({ ...validProps, dayOfWeek: 7 }).getError();
    ...
    it('fails when dayOfWeek is not an integer', () => {
      const error = Schedule.create({ ...validProps, dayOfWeek: 1.5 }).getError();
    ...
    it('fails when startTime has invalid format', () => {
      const error = Schedule.create({ ...validProps, startTime: '9:00' }).getError();
    ...
    it('fails when startTime has invalid hours', () => {
      const error = Schedule.create({ ...validProps, startTime: '25:00' }).getError();
    ...
    it('fails when endTime has invalid format', () => {
      const error = Schedule.create({ ...validProps, endTime: '1700' }).getError();
    ...
    it('creates a valid entity', () => {
      const entity = Schedule.create(validProps).getData();

      expect(entity).toBeInstanceOf(Schedule);
    ...
    it('accepts dayOfWeek 0 (Sunday)', () => {
      const entity = Schedule.create({ ...validProps, dayOfWeek: 0 }).getData();

      expect(entity.dayOfWeek.value).toBe(0);
    });

    it('accepts dayOfWeek 6 (Saturday)', () => {
      const entity = Schedule.create({ ...validProps, dayOfWeek: 6 }).getData();
  ...
  describe('reconstruct()', () => {
    it('reconstructs with the given id and code', () => {
      const entity = Schedule.reconstruct({ id: '5', code: 'sch123', ...validProps });
